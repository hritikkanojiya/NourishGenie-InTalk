						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bold my-1">
									<span class="text-white fs-1">Remaining Quota</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-semibold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-600">Remaining Quota</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
								...
								<div class="card-body pt-9 pb-0">
									...
									<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
										...
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5" href="foodDiary">Food Diary</a>
										</li>
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="remainingQuota">Remaining Quota</a>
										</li>
										<!--end::Nav item-->
									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-header pt-7">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark">Remaining Quota</span>
											</h3>
											<!--end::Title-->
										...
										<div class="table-responsive">
											...
											<table class="table align-middle gs-0 gy-4">
												...
												<thead>
													...
													<th class="text-center pe-3 min-w-100px">FOOD ITEMS</th>
												...
												<tbody>
												<tr>
														<td class="text-center">Vegetables</td>
														<td class="text-center">0 + 0</td>
													</tr>
												<tr>
														<td class="text-center">Roti Size 1</td>
														<td class="text-center">3</td>
													</tr>
												<tr>
														<td class="text-center">Steamed Rice</td>
														<td class="text-center">0</td>
													</tr>
												<tr>
														<td class="text-center">Pulse/Dal/Sprouts</td>
														<td class="text-center">0</td>
													</tr>
												<tr>
														<td class="text-center">Skimmed Milk / Curds</td>
												...
												<tr>
														<td class="text-center">Buscuits</td>
														<td class="text-center">3</td>
													</tr>
												<tr>
														<td class="text-center">Egg Whites</td>
														<td class="text-center">0</td>
													</tr>
												<tr>
														<td class="text-center">Almonds</td>
														<td class="text-center">0</td>
													</tr>
