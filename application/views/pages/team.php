									...
									<div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="../../demo9/dist/pages/team.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bold my-1">
									<span class="text-white fs-1">Our Team</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-semibold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-400">Our Team</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
								...
								<div class="card-body p-lg-17">
									...
									<div class="mb-18">
										...
										<div class="mb-11">
											...
											<div class="overlay">
												...
												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
													<a href="../../demo9/dist/pages/pricing/pricing-1.html" class="btn btn-primary">Pricing</a>
													<a href="../../demo9/dist/pages/careers/apply.html" class="btn btn-light-primary ms-3">Join Us</a>
												</div>
												<!--end::Links-->
											</div>
											<!--end::Overlay-->
										...
										<div class="fs-5 fw-semibold text-gray-600">
											...
											<a href="../../demo9/dist/pages/blog/post.html" class="link-primary pe-1">Your Post</a>(yes, thinking counts as working if you’re a blogger) before you actually write it.</p>
											<!--end::Text-->
										</div>
										<!--end::Description-->
									</div>
									...
									<div class="mb-18">
										...
										<div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Paul Miles</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Jania Garnbet</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">James Nilson</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Mia Miles</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Sophia Miles</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Oliver Lucas</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Amelia Miles</a>
													<!--end::Name-->
													<!--begin::Position-->
											...
											<div class="col text-center mb-9">
												...
												<div class="mb-0">
													<!--begin::Name-->
													<a href="../../demo9/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Liam James</a>
													<!--end::Name-->
													<!--begin::Position-->
													<div class="text-muted fs-6 fw-semibold">QA Managers</div>
													<!--begin::Position-->
									...
									<div class="text-center mb-20">
										...
										<!--end::Text-->
										<!--begin::Action-->
										<a href="../../demo9/dist/pages/careers/apply.html" class="btn btn-primary mb-5">Apply Now</a>
										<!--end::Action-->
									</div>
									<!--end::Join-->
									<!--begin::Card-->
