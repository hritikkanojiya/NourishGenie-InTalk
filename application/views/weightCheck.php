									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-header pt-7">
											...
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark">View Weight Check</span>
											</h3>
											<!--end::Title-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="text-center pe-3 min-w-150px">Weight (kgs)</th>
														<th class="text-center pe-3 min-w-100px">Waist (cms)</th>
														<th class="text-center pe-3 min-w-100px">Hip (cms)</th>
														<th class="text-center pe-3 min-w-100px">Client comment</th>
														<th class="text-center pe-3 min-w-100px">BMi kg/m2</th>
													</tr>
													<!--end::Table row-->
												</thead>
												<!--end::Table head-->
												...
												<tbody class="fw-bold text-gray-600">
													<tr>
														<td class="text-center">22nd Jul 2022</td>
