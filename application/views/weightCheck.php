						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bold my-1">
									<span class="text-white fs-1">View Weight Check</span>
								</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-line fw-semibold fs-7 my-1">
									...
									<li class="breadcrumb-item text-gray-600">View Weight Check</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
								...
								<div class="card-body pt-9 pb-0">
									...
									<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
										...
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="weightCheck">View Weight Check</a>
										</li>
										<!--end::Nav item-->
							...
							<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold fs-3 mb-1">View Weight Check</span>
									</h3>
										...
										<table class="table align-middle gs-0 gy-4">
											...
											<thead>
												<tr class="fw-bold text-muted bg-light">
													...
													<th class="min-w-125px">Weight (Kgs)</th>
													<th class="min-w-125px">Waist (Cms)</th>
													<th class="min-w-200px">Hip (Cms)</th>
													<th class="min-w-150px">Client comment</th>
													<th class="min-w-200px ">BMI Kg/M2</th>
												</tr>
											</thead>
											<!--end::Table head-->
											<!--begin::Table body-->
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="d-flex justify-content-start flex-column">
																<span class="text-muted fw-semibold text-muted d-block fs-7">22nd Jul 2022</span>
															</div>
														</div>
													</td>
													<td>
														<span class="text-muted fw-semibold text-muted d-block fs-7">65</span>
													</td>
													<td>
													...
													<td>
														<span class="text-muted fw-semibold text-muted d-block fs-7">27.41</span>
													</td>
