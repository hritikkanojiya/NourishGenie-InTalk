					...
					<div class="header-container container-xxl">
						...
						<div
							...
							<ul class="breadcrumb breadcrumb-line fw-semibold fs-7 my-1">
                                ...
                                <li class="breadcrumb-item text-gray-400">List of Medicines/Vitamins</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						<!--end::Page title=-->
								...
								<div class="card-body pt-9 pb-0">
									...
									<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
										...
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 " href="medicalHistory">Medical History</a>
										</li>
										<!--end::Nav item-->
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
										...
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="listOfMedicine">List of Medicines/Vitamins</a>
										</li>
										<!--end::Nav item-->
										<!--begin::Nav item-->
										<li class="nav-item mt-2">
								...
								<div class="card card-flush h-md-100">
									...
									<div class="card-header pt-7">
										...
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bold text-gray-800">List of Medicines/Vitamins</span>
										</h3>
										<!--end::Title-->
											...
											<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
												...
												<thead>
													<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
														<th class="p-0 pb-3 min-w-100px text-center">NAME</th>
														<th class="p-0 pb-3 min-w-100px text-center">DOSAGE</th>
														<th class="p-0 pb-3 min-w-100px text-center">TIMING</th>
														<th class="p-0 pb-3 min-w-100px text-center">PURPOSE</th>
														<th class="p-0 pb-3 min-w-100px text-center">REPORT STATUS</th>
														<th class="p-0 pb-3 min-w-100px text-center">REPORT TEXT</th>
													</tr>
												</thead>
												<!--end::Table head-->
												<!--begin::Table body-->
