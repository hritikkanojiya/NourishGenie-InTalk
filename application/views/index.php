						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="row g-5 g-xl-8">
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637e00e61b745">
													<!--begin::Header-->
													<div class="px-7 py-5">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637e00e61b745" data-allow-clear="true">
																	<option></option>
								...
								<div class="col-xl-8 ps-xl-12">
									...
									<div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8" style="background-color: ;background-position: 100% 50px;background-size: 500px auto;background-image:url('<?= base_url(); ?>assets/media/misc/city.png')" data-theme="light">
										<!--begin::Body-->
													...
													<div class="d-flex flex-column mt-10">
														...
														<div class="d-flex">
															...
															<a href="#" class="symbol symbol-35px me-2" data-bs-toggle="tooltip" title="Mark Larson">
																<img src="<?= base_url(); ?>assets/media/avatars/300-5.jpg" alt="" />
															</a>
															...
															<a href="#" class="symbol symbol-35px" data-bs-toggle="tooltip" title="Alice Micto">
																<img src="<?= base_url(); ?>assets/media/avatars/300-10.jpg" alt="" />
															</a>
														</div>
													</div>
													<!--end:Team-->
